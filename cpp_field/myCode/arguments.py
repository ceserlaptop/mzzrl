...
def parse_args():
    ...
    # checkpointing
    parser.add_argument("--fre_save_model", type=int, default=10000, help="the number of the episode for saving the model")
    parser.add_argument("--save_dir", type=str, default="models", help="directory in which training state and model \
    should be saved")
    # parser.add_argument("--old_model_name", type=str, default="coverage_0/coverage_0_01_28_20_36/policy/coverage_0_0131_152811_100000/", help="directory in \
    # which training state and model are loaded")
    parser.add_argument("--old_model_name", type=str, default="models/coverage_0_0120_101441_100000/", help="directory in \
        which training state and model are loaded")
